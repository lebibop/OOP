...
public class LocalDateCellFactory_Client_arr implements Callback<TableColumn<Client, LocalDate>, TableCell<Client, LocalDate>> {
    ...
    public TableCell<Client, LocalDate> call(TableColumn<Client, LocalDate> col) {
        return new TableCell<Client, LocalDate>() {
            ...
            public void commitEdit(LocalDate newValue) {
                ...
                data.setDate_arrival(Date.valueOf(newValue).toLocalDate());
